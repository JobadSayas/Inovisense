                    ...
                    <tr class="h-11 border-b border-gray-300">
                        ...
                        <td class="py-2 px-4 text-right">
                            <div class="relative inline-block">
                                ...
                                <div class="absolute z-10 border border-gray-300 rounded-md flex flex-col bg-white shadow-lg p-3 w-[200px] top-8 right-0">
                                    <button class="text-left hover:bg-gray-100 p-2 rounded">Manage devices</button>
                                    <button class="text-left hover:bg-gray-100 p-2 rounded">Rename location</button>
